...
```
cd existing_repo
git remote add origin https://gitlab.coretechs.com/coretechs-misc/darts-app.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.coretechs.com/coretechs-misc/darts-app/-/settings/integrations)
