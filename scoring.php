...
<tr colspan = "15">
  <td colspan = "5" id = "undoCell"><button id = "input_undo" class ="button" name ="inputButton">Undo</button></td>
  <td colspan = "5"><button class="button" id = "doubleButton" onclick="multiplier('double')">Double</button></td>
  <td colspan = "5"><button class="button" id = "tripleButton" onclick="multiplier('triple')">Triple</button></td>
</tr>
<tr colspan ="15">
  <td colspan ="3"><button id = "input_20" class="button numInput" name ="inputButton" >20</button></td>
  ...
  <td colspan ="3"><button id = "input_16" class="button numInput" name ="inputButton">16</button></td>
</tr>
<tr>
  <td colspan ="3"><button id = "input_15" class="button numInput" name ="inputButton">15</button></td>
  ...
  <td colspan ="3"><button id = "input_11" class="button numInput" name ="inputButton">11</button></td>
</tr>
<tr>
  <td colspan ="3"><button id = "input_10" class="button numInput" name ="inputButton">10</button></td>
  ...
  <td colspan ="3"><button id = "input_6" class="button numInput" name ="inputButton">6</button></td>
</tr>
<tr>
  <td colspan ="3"><button id = "input_5" class="button numInput" name ="inputButton">5</button></td>
  ...
  <td colspan ="3"><button id = "input_1" class="button numInput" name ="inputButton">1</button></td>
</tr>
<tr>
  <td colspan="6"><button id = "input_25" class="button" name ="inputButton">Bull</button></td>
  <td colspan="9"><button class="button" onclick="submitTurn()">Enter Turn</button></td>
</tr>
</table>
<script>
